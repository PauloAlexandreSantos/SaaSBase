...
Route::middleware(['auth'])->group(function () {
 ...
 Route::put('admin/Quem-é-Quem/update/{id}', ['as' => 'admin.whoIsWho.update', 'uses' => 'Admin\WhoIsWhoController@update']);
   ...
   /**about */
   Route::get('admin/informações-uteis/show', ['as' => 'admin.usefulInformation.show', 'uses' => 'Admin\UsefulInformationController@show']);
   Route::get('admin/informações-uteis/edit/{id}', ['as' => 'admin.usefulInformation.edit', 'uses' => 'Admin\UsefulInformationController@edit']);
   Route::put('admin/informações-uteis/update/{id}', ['as' => 'admin.usefulInformation.update', 'uses' => 'Admin\UsefulInformationController@update']);
...
/* End imagehostelList */
        ...
        /* end news */
         ...
         /* Accreditation */
         Route::get('admin/acreditação/index', ['as' => 'admin.accreditation.index', 'uses' => 'Admin\AccreditaionController@index']);
         Route::get('admin/acreditação/show', ['as' => 'admin.accreditation.show', 'uses' => 'Admin\AccreditaionController@show']);
         Route::get('admin/acreditação/edit/{id}', ['as' => 'admin.accreditation.edit', 'uses' => 'Admin\AccreditaionController@edit']);
         Route::put('admin/acreditação/update/{id}', ['as' => 'admin.accreditation.update', 'uses' => 'Admin\AccreditaionController@update']);
         /* end Accreditation */
    });
});
